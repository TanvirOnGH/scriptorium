# Source: https://raw.githubusercontent.com/CharlesMod/quantizeHFmodel/main/quantizeHQQ.py
...
if __name__ == "__main__":
    ...
    output_dir = (
        "quantized_models"  # Name of the output directory for storing quantized models
    )
