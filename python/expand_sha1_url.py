...
def expand_sha1_url(repo, short_sha1):
    ...
    if response.status_code == 200:
        ...
        print(
            "Error: Could not find the commit. Make sure the short SHA-1 value is correct and try again."
        )


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Expand short SHA-1 to full commit URL."
    )
    parser.add_argument(
    ...
    short_sha1 = (
        args.short_sha1 if args.short_sha1 else input("Enter the short SHA-1 value: ")
    )
